...
<head>
    ...
    <title>Galarry(Stuff) - PCEA Schools</title>
...
<body>
    ...
    <div class="fixed bottom-4 ml-3  bg-blue-800 text-white p-4 rounded-full shadow-lg hover:bg-blue-600 transition-all">
        ...
        <a href="trip.php" class="hover:underline font-bold px-4">Trips</a>
        <a href="service.php" class="hover:underline font-bold">Service</a>
